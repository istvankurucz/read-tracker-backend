...
export function createReadingSnapshotSchema(params: { maxPages: number }) {
	// Extract params
...
export type CreateReadingSnapshotData = z.infer<ReturnType<typeof createReadingSnapshotSchema>>;
